...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.TRAINING.TRAIN_DIR_KCL = 'images_dir/train'
        self._C.TRAINING.TRAIN_DIR_RLE = 'images_dir/train'
        self._C.TRAINING.VAL_DIR_KCL = 'images_dir/val'
        self._C.TRAINING.VAL_DIR_RLE = 'images_dir/val'
        self._C.TRAINING.SAVE_DIR = 'checkpoints'
        self._C.TRAINING.TRAIN_PS = 64
        self._C.TRAINING.VAL_PS = 64

        self._C.TRAINING.SAVE_AE_DIR = './AE_model' 
