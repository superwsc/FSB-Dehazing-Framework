...
parser = argparse.ArgumentParser(description='Image Dehazing using Fast Saturation Based Dehazing Framework')

parser.add_argument('--input_dir', default='../SOTS_outdoor/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./result_SOTS/', type=str, help='Directory for results')
parser.add_argument('--weights', default='SE_model/model_best.pth', type=str, help='Path to weights')
